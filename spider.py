...
def get_baidu_hot():
    ...
    dl = browser.find_element_by_css_selector('#ptab-1 > div.Virus_1-1-304_2SKAfr > div.Common_1-1-304_3lDRV2 > span')
    dl.click()
    time.sleep(1)
    # 找到热搜标签
    ...
    # for j in range(1, 21):
    #     c = browser.find_elements_by_xpath('//*[@id="ptab-1"]/div[3]/div[i]/div[2]/a/div'.format(j))
